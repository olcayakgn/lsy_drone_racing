...
class SpatialScenarioMPCController(Controller):
    ...
    DIP_APPROACH_DIST = 0.55      # approach distance for wrong-side (dip) gates [m]
    ...
    def _generate_references(
        ...
        for k in range(self.MPC_N + 1):
            ...
            if k < self.MPC_N:
                ...
                if dist_to_gate < self.ALIGN_START_DIST and (
                    float(np.dot(ref_pos[k] - gp, normal)) <= self.DIP_ALIGN_GUARD
                ):
